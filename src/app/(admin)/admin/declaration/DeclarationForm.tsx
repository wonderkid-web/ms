...
const schema = z.object({
  ...
  pabrik: optionSchema.extend({}).refine(val => !!val, { message: 'Wajib pilih pabrik' }),
...
const produkOptions: OptionType[] = [{ value: 'cpo', label: 'CPO' }, { value: 'pko', label: 'PKO' }];
const groupOptions: OptionType[] = [{ value: 'MAHKOTA', label: 'MAHKOTA' }];
const supplierOptions: OptionType[] = [{ value: 'sup1', label: 'Supplier A' }, { value: 'sup2', label: 'Supplier B' }];
    ...
    <div className="mx-auto max-w-3xl rounded-xl border bg-white p-5 shadow-sm md:p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 text-[16px]">
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  <Select<PabrikOption>
                    ...
                    onChange={(opt: SingleValue<PabrikOption>) => {
                      field.onChange(opt);
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select<OptionType, true>
                    ...
                    onChange={(val: MultiValue<OptionType>) => field.onChange(val)}
                  />
                )}
              />
            </Field>
        ...
        <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end">
          <Button type="button" variant="outline" className="h-11 px-5 text-[15px]">
            Batal
          </Button>
